...
class DataanakController extends Controller
{
    ...
    {
        $data['Ibu'] = DataIbuModel::where(['is_deleted' => 0])->get();
        $data['list'] = DataAnakModel::where(['is_deleted' => 0])->with('Dataibu')->get();
        return view('admin.dataanak.index', $data);
    }
    ...
    function getdata(Request $request)
    {
        ...
        $data['imun'] = ImunisasiModel::where(['id_anak' => $request->id])->where(['is_deleted' => 0])->with('data_anak')->with('vaksin')->get();
        ...
        return view('admin.dataanak.detail', $data);
    }
}
