                ...
                <div class="sidebar">
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.dataibu.index')}}" class="nav-link">
                                    <i class="nav-icon fas fa-female"></i>
                                    <p> Data Ibu </p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.dataanak.index')}}" class="nav-link">
                                    <i class="nav-icon fas fa-child"></i>
                                    <p> Data Anak</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.datapetugas.index')}}" class="nav-link">
                                    <i class="nav-icon fas fa-users"></i>
                                    <p> Data Petugas</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{ route('admin.databidan.index')}}" class="nav-link">
                            ...
                            <li class="nav-item">
                                <a href="{{ route('admin.timbangan.create') }}" class="nav-link">
                            ...
                            <li class="nav-item">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{route('admin.timbangan.index')}}" class="nav-link">
                                            <i class="nav-icon far fa-circle"></i>
                                            <p> Data Timbangan Anak</p>
                                        </a>
                                    </li>
                                    {{-- <li class="nav-item">
                                        <a href="jacascript:void(0)" class="nav-link">
                                            <i class="nav-icon far fa-circle"></i>
                                            <p> Data Status Gizi Anak</p>
                                        </a>
                                    </li> --}}
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.imunisasi.index')}}" class="nav-link">
                                    <i class="nav-icon fas fa-vials"></i>
                                    <p> Imunisasi Anak</p>
                                </a>
                            </li>
                            <!-- <li class="nav-item">
                                <a href="{{route('admin.vitamin.index')}}" class="nav-link">
